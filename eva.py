...
def calculate_iou(nb_classes, res_dir, label_dir, image_list, label_list):
    ...
    for img_num1, img_num2 in zip(image_list, label_list):
        ...
        label = img_to_array(Image.open('%s/%s' % (label_dir, img_num2))).astype(int)
...
label_list = open('/home/robotics/PycharmProjects/Database/test.txt').readlines()
label_dir = os.path.expanduser('/home/robotics/PycharmProjects/Database/Test-label')
image_list = open('/home/robotics/PycharmProjects/predict_results/FCN_1/pre.txt').readlines()
res_dir = os.path.expanduser('/home/robotics/PycharmProjects/predict_results/FCN_1')
